...
import io.puzzlebox.jigsaw.protocol.RedBearLabsGattAttributes;
...
public class RedBearLabsService extends Service {
	...
	public final static UUID UUID_BLE_SHIELD_TX = UUID
			.fromString(RedBearLabsGattAttributes.BLE_SHIELD_TX);
	public final static UUID UUID_BLE_SHIELD_RX = UUID
			.fromString(RedBearLabsGattAttributes.BLE_SHIELD_RX);
	public final static UUID UUID_BLE_SHIELD_SERVICE = UUID
			.fromString(RedBearLabsGattAttributes.BLE_SHIELD_SERVICE);
	...
	public void setCharacteristicNotification(
		...
		if (UUID_BLE_SHIELD_RX.equals(characteristic.getUuid())) {
			BluetoothGattDescriptor descriptor = characteristic
					.getDescriptor(UUID
							.fromString(RedBearLabsGattAttributes.CLIENT_CHARACTERISTIC_CONFIG));
			descriptor
