...
public class SessionFileGoogleDrive extends Activity implements ConnectionCallbacks,
		  OnConnectionFailedListener {

	private static final String TAG = SessionFileGoogleDrive.class.getSimpleName();
