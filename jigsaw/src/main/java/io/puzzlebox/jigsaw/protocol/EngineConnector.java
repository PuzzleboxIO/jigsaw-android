...
//	public static EngineConnector shareInstance() {
	public static EngineConnector shareInstance(Context context) {
		if (engineConnectInstance == null) {
			engineConnectInstance = new EngineConnector(context);
		}
		return engineConnectInstance;
	}

//	public EngineConnector() {
	public EngineConnector(Context context) {
		connectEngine(context);
	}

//	private void connectEngine() {
	private void connectEngine(Context context) {
